...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vbuck Core vbuck-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vbuck-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vbuck transaction") + "\n" +
                               "  vbuck-tx [options] -create [commands]   " + _("Create hex-encoded vbuck transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vbuck transaction
