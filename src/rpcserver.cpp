...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vbuck features */
        {"vbuck", "masternode", &masternode, true, true, false},
        {"vbuck", "listmasternodes", &listmasternodes, true, true, false},
        {"vbuck", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vbuck", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vbuck", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vbuck", "masternodedebug", &masternodedebug, true, true, false},
        {"vbuck", "startmasternode", &startmasternode, true, true, false},
        {"vbuck", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vbuck", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vbuck", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vbuck", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vbuck", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vbuck", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vbuck", "mnbudget", &mnbudget, true, true, false},
        {"vbuck", "preparebudget", &preparebudget, true, true, false},
        {"vbuck", "submitbudget", &submitbudget, true, true, false},
        {"vbuck", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vbuck", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vbuck", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vbuck", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vbuck", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vbuck", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vbuck", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vbuck", "checkbudgets", &checkbudgets, true, true, false},
        {"vbuck", "mnsync", &mnsync, true, true, false},
        {"vbuck", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> vbuck-cli " + methodname + " " + args + "\n";
}
