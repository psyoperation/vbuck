...
/** Utility functions used by the Vbuck Qt UI.
 */
namespace GUIUtil
{
...
// Render VBUCK addresses in monospace font
...
// Parse "vbuck:" URI into recipient object, return true on successful parsing
