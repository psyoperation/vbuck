                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Vbuck Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VBUCK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vbuck: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vbuck Core"), this);
    aboutAction->setStatusTip(tr("Show information about Vbuck Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Vbuck"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VBUCK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VBUCK addresses"));
    ...
    openAction->setStatusTip(tr("Open a vbuck: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Vbuck Core help message to get a list with possible Vbuck command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vbuck Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vbuck network", "", count));
}
...
{
    QString strTitle = tr("Vbuck Core"); // default title
