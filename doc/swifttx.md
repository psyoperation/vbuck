...
This mechanism has been integrated into Bitcore-Node-Vbuck which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/vbuck-project/insight-api-vbuck#web-socket-api](https://github.com/vbuck-project/insight-api-vbuck#web-socket-api)
* API: [https://github.com/vbuck-project/insight-api-vbuck#swifttx-transactions](https://github.com/vbuck-project/insight-api-vbuck#swifttx-transactions)
...
By default, the Vbuck Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Vbuck Core daemon:
