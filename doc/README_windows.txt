...
Intro
-----
Vbuck (VBUCK) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Vbuck utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run vbuck-qt.exe.

Vbuck Core is the original Vbuck client and it builds the backbone of the network.
However, it downloads and stores the entire history of Vbuck transactions;
