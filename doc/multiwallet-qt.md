...
In order to support loading of multiple wallets in vbuck-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vbuck.cpp.
...
Changes to vbuck.cpp
----------------------
vbuck.cpp is the entry point into vbuck-qt, and as such, will require some minor modifications to provide hooks for
