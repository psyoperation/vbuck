...
#   c) node1 mines 32 blocks, so now node 0 has 500000VBUCK, node 1 has 4250VBUCK, node2 has none.
#   d) node0 sends 601 VBUCK to node2, in two transactions (301 VBUCK, then 300 VBUCK).
