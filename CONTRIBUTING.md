Contributing to Vbuck Core
==================================

The Vbuck Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vbuck Core project, and is not to be
confused with overall Vbuck Network Protocol consensus changes.

Whether a pull request is merged into Vbuck Core rests with the project merge
...
Patches that change Vbuck consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vbuck consensus, it must have been
...
The project leader is the release manager for each Vbuck Core release.
