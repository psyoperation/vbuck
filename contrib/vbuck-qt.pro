...
RESOURCES += src/qt/vbuck.qrc src/qt/vbuck_locale.qrc

TRANSLATIONS += src/qt/locale/vbuck_bg.ts \
                src/qt/locale/vbuck_de.ts \
                src/qt/locale/vbuck_en.ts \
                src/qt/locale/vbuck_es.ts \
                src/qt/locale/vbuck_fi.ts \
                src/qt/locale/vbuck_fr.ts \
                src/qt/locale/vbuck_it.ts \
                src/qt/locale/vbuck_ja.ts \
                src/qt/locale/vbuck_pl.ts \
                src/qt/locale/vbuck_pt.ts \
                src/qt/locale/vbuck_ru.ts \
                src/qt/locale/vbuck_sk.ts \
                src/qt/locale/vbuck_sv.ts \
                src/qt/locale/vbuck_vi.ts \
                src/qt/locale/vbuck_zh_CN.ts \
                src/qt/locale/vbuck_zh_TW.ts
